...
//                     <h2 className="text-2xl lg:text-3xl font-bold text-textBlack text-center pb-1 lg:pb-2 px-4 pt-4 lg:pt-6 2xl:pt-8">Congratulations, account created successfully</h2>

//                     <Link href={'/'}>
//                         <button
//                             className="appBtn w-full mt-4"
//                         >
//                             Go to Marketplace
//                         </button>
//                     </Link>
